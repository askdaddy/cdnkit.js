/*! cdnkit.js build:1.0.0, development. Copyright(c) 2015 Seven Chen <humen1@gmail.com> */
(function e(t, n, r) {
    function s(o, u) {
        if (!n[o]) {
            if (!t[o]) {
...
//module.exports.getUserMedia = navigator.getUserMedia || (navigator.getUserMedia = navigator.mozGetUserMedia ||  navigator.webkitGetUserMedia || navigator.msGetUserMedia);
    ...
    }, {"./dom": 3, "./util": 5, "eventemitter3": 6}], 3: [function (require, module, exports) {
        /**
         * Created by seven on 15/6/21.
         */
        var util = require('./util');
    ...
    }, {"./util": 5, "eventemitter3": 6}], 4: [function (require, module, exports) {
        /**
         * Created by seven on 15/6/21.
         */
    ...
    }, {"./adapter": 1, "./cdnkit": 2, "./dom": 3, "./util": 5}], 5: [function (require, module, exports) {
        /**
         * Created by seven on 15/6/21.
         */
        var defaultConfig = {
